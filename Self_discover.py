...
def generate_comment_prompt(db_path, question, engine, api_key, knowledge=None):
    ...
    reasoning_structure = implement_reasoning_structure(adapted_modules, question, engine)
    ...
    if not knowledge_prompt:
        result_prompt= "{}\n{}\n{}\n{}".format(pattern_prompt_no_kg, question_prompt, schema_prompt, reasoning_structure)
    else:
        result_prompt= "{}\n{}\n{}\n{}\n{}".format(knowledge_prompt, pattern_prompt_kg, question_prompt, schema_prompt, reasoning_structure)
